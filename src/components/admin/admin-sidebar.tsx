...
import { ShieldCheck, Users, LayoutDashboard, LogOut, Menu, X, UserPlus, FileCheck2 } from 'lucide-react'
...
const navItems = [
  ...
  { href: '/admin/bills', label: 'Bill Reviews', icon: FileCheck2 },
          ...
          return (
            <Link key={href} href={href} onClick={() => setMobileOpen(false)}
              className={cn(
                ...
                active ? 'bg-violet-50 text-violet-700' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'
              )}
            >
